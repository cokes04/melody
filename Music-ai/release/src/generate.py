...
def get_midi(model, data_for_emotion, tables, emotion, music_len, noise_num, save) :
    print("Generate Main")
...
def convert_midi(prediction_output, int_to_note, int_to_duration, emotion, random_index, save=False) :
    print("Convert Midi")
